...
* *Lab URL*: https://web.cs.dal.ca/~kwankaw/csci3172/lab5/index.html
* *GIT URL*: https://git.cs.dal.ca/kwankaw/csci-3172.git
...
* [Kwankaw Boonyapakorn](kboonyapakorn@dal.ca) - (developer, owner)
...
CSS3 - The style sheet language used to design and layout web pages, including styling, animations, and responsive design.
